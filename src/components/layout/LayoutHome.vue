<template>
    <div>
        ...
        <div class="hidden md:fixed md:inset-y-0 md:flex md:w-72 md:flex-col">
            ...
            <div
                class="flex flex-grow flex-col justify-between overflow-y-auto bg-white pt-5 dark:bg-gray-800 duration-200">
                <div>
                    <div class="flex items-center px-4">
                        <img class="h-14 w-auto" v-if="!isDark"
                            src="https://avatars.githubusercontent.com/u/113456527?s=200&v=4" alt="cant load data" />
                        <img class="h-14 w-auto" v-else src="/logo-dark.png" alt="cant load data" />
                        ...
                        <nav class="flex-1 pb-4">
                            <ui-tabs class="space-y-2">
                                <ui-tab as="div" v-for="item in navigation" :key="item.name" class="px-5"
                                    ...
                                    <a :href="item.href"
                                        :class="[item.current ? 'bg-black text-white dark:bg-white dark:text-black'
            ...
            <div class="sticky top-0 z-10 flex h-16 flex-shrink-0">
                ...
                <div
                    ...
                    <div class=" ml-4 flex items-center md:ml-6">
                        ...
                        <ui-button buttonClass="py-2 px-2 ml-3" rounded="rounded-[0.8rem]" variant=""
                            @click="toggleDark()">
                            <svg v-if="isDark" viewBox=" 0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="w-7 h-7">
                                <path d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" class="fill-transparent stroke-white">
                                </path>
                                <path
